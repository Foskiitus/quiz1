...
$(stage).append('<div class="questionText">'+questionBank[questionNumber][0]+'</div><div id="1" class="option option1">'+q1+'</div><div id="2" class="option option2">'+q2+'</div><div id="3" class="option option1">'+q3+'</div>');
